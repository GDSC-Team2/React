      ...
      <Navbar className="shadow-sm p-3 mb-5 bg-white rounded">
        <Container>
          ...
          <Nav className="ml-auto">
            <a href="https://toyproject-sook.herokuapp.com/oauth2/authorization/google?redirect_uri=http://localhost:3000/oauth2/redirect"><Button className={styles.login}>Google 로그인</Button></a>
            {/* 로그인 시 */}
